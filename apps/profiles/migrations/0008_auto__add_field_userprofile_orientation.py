...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.orientation'
        db.add_column('profiles_userprofile', 'orientation', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.orientation'
        db.delete_column('profiles_userprofile', 'orientation')
    ...
    models = {
        ...
        'profiles.photo': {
            ...
            'album': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'photos'", 'to': "orm['profiles.PhotoAlbum']"}),
        ...
        'profiles.photoalbum': {
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.utcnow'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'photoalbums'", 'to': "orm['auth.User']"})
        },
