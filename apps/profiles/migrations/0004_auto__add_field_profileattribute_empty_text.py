...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProfileAttribute.empty_text'
        db.add_column('profiles_profileattribute', 'empty_text', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProfileAttribute.empty_text'
        db.delete_column('profiles_profileattribute', 'empty_text')
